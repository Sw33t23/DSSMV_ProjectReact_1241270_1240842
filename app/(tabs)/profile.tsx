...
export default function ProfileScreen() {
  const { user, watchlist, viewed, ratings } = useAppStore();
  ...
  // Calculate some fun stats for the professor to see
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.menuContainer}>
        ...
        <TouchableOpacity style={styles.menuItem} onPress={() => Alert.alert("Coming Soon", "Privacy settings are under development.")}>
...
const styles = StyleSheet.create({
  ...
  statsContainer: { flexDirection: 'row', backgroundColor: '#fff', margin: 20, borderRadius: 15, padding: 20, elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4 },
  ...
  logoutButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', padding: 15, borderRadius: 10, marginTop: 10, borderWidth: 1, borderColor: '#ffebeb' },
